...
public class SMessageStartGameConfirm implements IMessage {

	private BlockPos pos;
	private int worldId;

	public SMessageStartGameConfirm() {
	}

	public SMessageStartGameConfirm(World world, BlockPos pos) {
		this.pos = pos;
	...
	public static class Handler implements IMessageHandler<SMessageStartGameConfirm, IMessage> {
		@Override
		public IMessage onMessage(SMessageStartGameConfirm msg, MessageContext ctx) {

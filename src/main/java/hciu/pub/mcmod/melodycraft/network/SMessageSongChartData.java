...
public class SMessageSongChartData implements IMessage {

	private BlockPos pos;
	private int worldId;

	public SMessageSongChartData() {
	}

	public SMessageSongChartData(World world, BlockPos pos) {
		this.pos = pos;
	...
	public static class Handler implements IMessageHandler<SMessageSongChartData, IMessage> {
		@Override
		public IMessage onMessage(SMessageSongChartData msg, MessageContext ctx) {

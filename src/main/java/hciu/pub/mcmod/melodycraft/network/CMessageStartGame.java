...
public class CMessageStartGame implements IMessage {

	private BlockPos pos;
	private int worldId;

	public CMessageStartGame() {
	}

	public CMessageStartGame(World world, BlockPos pos) {
		this.pos = pos;
	...
	public static class Handler implements IMessageHandler<CMessageStartGame, IMessage> {
		@Override
		public IMessage onMessage(CMessageStartGame msg, MessageContext ctx) {
